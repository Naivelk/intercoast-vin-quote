...
export const translations: { [key: string]: any } = {
  es: {
    ...
    testimonials: {
      ...
      subtitle: 'Más de 10,000 familias en California confían en InterCoast.',
      review1: 'El mejor servicio que he recibido. Me explicaron todo en español, sin letra chica y con mucha paciencia. Conseguí un precio muy bueno para mi seguro de auto. ¡Los recomiendo al 100%!',
      client1: 'María G. — South Gate, CA',
      review2: 'Llevaba años pagando demasiado con otra compañía. InterCoast me ayudó a ahorrar casi $80 al mes sin perder cobertura. El proceso fue rápido y todo por WhatsApp. ¡Gracias!',
      client2: 'Carlos R. — Compton, CA',
      review3: 'Tuve un accidente y no sabía qué hacer. La agente me guió paso a paso, habló con el seguro por mí y resolvieron todo en días. Un servicio increíble, de verdad los recomiendo.',
      client3: 'Jenniffer L. — Lynwood, CA',
      review4: 'Muy profesionales y atentos. Me cotizaron varias opciones y encontré el plan perfecto para mi familia. Desde que los conozco ya no busco más. InterCoast es mi seguro de por vida.',
      client4: 'Roberto M. — Huntington Park, CA',
      review5: 'Lo que más me gustó fue la rapidez. Mandé mi información y en menos de 20 minutos ya tenía mi póliza lista. Precio justo y excelente atención al cliente.',
      client5: 'Ana P. — Bell, CA',
      review6: 'Nunca había tenido seguro porque pensaba que era complicado. Con InterCoast fue facilísimo, todo en español y a un precio que puedo pagar. Ya le dije a toda mi familia.',
      client6: 'Miguel T. — South Gate, CA',
    },
    footer: {
  ...
  en: {
    ...
    testimonials: {
      ...
      subtitle: 'Over 10,000 families in California trust InterCoast.',
      review1: 'The best service I have ever received. They explained everything in Spanish, no fine print and very patient. I got a great price for my car insurance. 100% recommended!',
      client1: 'María G. — South Gate, CA',
      review2: 'I had been overpaying with another company for years. InterCoast helped me save almost $80 a month without losing coverage. The process was fast and all through WhatsApp. Thank you!',
      client2: 'Carlos R. — Compton, CA',
      review3: 'I had an accident and did not know what to do. The agent guided me step by step, spoke with the insurance on my behalf and resolved everything in days. Amazing service.',
      client3: 'Jenniffer L. — Lynwood, CA',
      review4: 'Very professional and attentive. They quoted me several options and I found the perfect plan for my family. Since I found them I do not look anywhere else. InterCoast is my insurance for life.',
      client4: 'Roberto M. — Huntington Park, CA',
      review5: 'What I liked most was the speed. I sent my information and in less than 20 minutes I had my policy ready. Fair price and excellent customer service.',
      client5: 'Ana P. — Bell, CA',
      review6: 'I had never had insurance because I thought it was complicated. With InterCoast it was very easy, everything in Spanish and at a price I can afford. I already told my whole family.',
      client6: 'Miguel T. — South Gate, CA',
    },
    footer: {
