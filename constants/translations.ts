...
export const translations: { [key: string]: any } = {
  es: {
    ...
    testimonials: {
      ...
      review1: 'Tienen buenos precios y muy buena atención!',
      client1: 'Angelica R.',
      review2: 'Excelente servicio 👍🏻 Gracias por ayudar a nuestra comunidad',
      client2: 'Tyan Z.',
  ...
  en: {
    ...
    testimonials: {
      ...
      review1: 'They have great prices and very good service!',
      client1: 'Angelica R.',
      review2: 'Excellent service 👍🏻 Thank you for helping our community',
      client2: 'Tyan Z.',
