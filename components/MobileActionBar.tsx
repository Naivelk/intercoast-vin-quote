...
const MobileActionBar: React.FC = () => (
  <div className="md:hidden fixed bottom-0 inset-x-0 z-50 bg-white/95 backdrop-blur border-t border-slate-200 p-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] grid grid-cols-2 gap-2 shadow-[0_-10px_25px_rgba(15,23,42,0.12)]">
    ...
    <a href="https://wa.me/15623787804?text=Hola%2C%20necesito%20ayuda%20con%20un%20seguro%20de%20Intercoast%20Insurance." target="_blank" rel="noreferrer" aria-label="Hablar con Intercoast Insurance por WhatsApp" className="rounded-xl bg-[#25D366] py-3 text-center text-sm font-bold text-white">WhatsApp</a>
  </div>
);
